...
comando construtor que deve ser informado logo após o include, sendo t0, t1 variáveis do tipo int8_t que definem o(s) tipo(s) de motor conectado(s) ao microcontrolador, sendo possível os seguintes valores:
